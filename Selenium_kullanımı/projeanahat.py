...
buton = tk.Button(pencer,text="1)Hesaplara profil fotoğrafı ekleyin",bg="black",fg="red",font="Tines 10",command=pp_ekle())
buton.pack(side=TOP,anchor=W,expand=NO)

buton = tk.Button(pencer,text="2)Hesaplara gönderi ekleyin",bg="black",fg="red",font="Tines 10",command=h_g_ekle())
buton.pack(side=TOP,anchor=W,pady=10)

buton = tk.Button(pencer,text="3)Hesapların bir profili takip etmesini sağlayın",bg="black",fg="red",font="Tines 10",command=takip1())
buton.pack(side=TOP,anchor=W,expand=NO)

buton = tk.Button(pencer,text="4)Bir hesaba (şikayet) spam saldırısında bulunun (BİLGİLENDİRME AMAÇLIDIR!!!)",bg="black",fg="red",font="Tines 10",command=spam())
buton.pack(side=TOP,anchor=W,pady=10)
